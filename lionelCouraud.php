...
<div style="display:flex; flex-direction:row; margin-right:10%;margin-left:10%;">
<div class="img" style="border:none; margin-right:1%; width:60%;>
 <a target="_blank" href="LionelCouraud.php"><!-- lien quand on clique sur l'image....   -->
   <?php
		if (preg_match('~MSIE|Internet Explorer~i', $_SERVER['HTTP_USER_AGENT']) || (strpos($_SERVER['HTTP_USER_AGENT'], 'Trident/7.0; rv:11.0') !== false) || (strpos($_SERVER['HTTP_USER_AGENT'], 'windows phone') !== false)) {
			
			echo "<img src=\"../image/personnels/LionelPP.jpg\" width=\"100%\" >";
		}
		else {
  ...
  <div style="display:flex; flex-direction:column; width:45%;"><?php echo "Dr vétérinaire Lionel Couraud<br>Laboratoire d'anatomie pathologique vétérinaire du sud ouest<br>31 200 Toulouse<br>Courriel: <a href=\"mailto:L.couraud@lapv80.fr\">L.couraud@lapv80.fr</a> ";   ?></div>
	</div>
