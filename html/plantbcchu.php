...
<div class="img" style="position:relative; top:5%; left:10%; width:200%;">
 <a target="_blank" href="plantbcchu.php"><!-- lien quand on clique sur l'image....   -->
   <?php
		if (preg_match('~MSIE|Internet Explorer~i', $_SERVER['HTTP_USER_AGENT']) || (strpos($_SERVER['HTTP_USER_AGENT'], 'Trident/7.0; rv:11.0') !== false) || (strpos($_SERVER['HTTP_USER_AGENT'], 'windows phone') !== false)) {
			
			echo "<img src=\"image/plantbcchu.jpg\" width=\"50%\" >";
		}
		else {
			
		echo "<img src=\"../image/plantbcchu\" width=\"50%\" >";
		}
		?>
  </a><br>
  <div><?php echo "plan réseau \"tbc\" vers le chu \"Xavier Xernozan\"";   ?></div>
	</div>
