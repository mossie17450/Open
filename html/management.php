...
<div  style="display:flex; flex-direction:row; margin-right:5%;">
	<div class="img" style="border:none; margin-right:1%; width:20%;">
...
";
	...
	<div style="display:flex; flex-direction:column; width:15%;"><h3>Pr Laurence Bordenave, MD, PhD.</h3><h4><?php echo TXT_coordinateurM ; ?></h4></div>
	
	<div class="img" style="border:none; width:20%; margin-right:1%;">
...
";
	...
	<div style="display:flex; flex-direction:column; width:15%;"><h3>Marlène Durand, PhD.</h3><h4><?php echo TXT_coordinateurD ;  ?></h4></div>
</div>
