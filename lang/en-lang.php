  <?php
	...
	<li><a href=\"html/cic-it-publications.php\">Our achievements</a></li>
	 ...
	 <li><a href=\"html/cic-it-spontanee.php\">CV and unsolicited applications</a></li></ul></li>
...
It is supported by <a target=\"_blank\" href=\"http://www.biotis-bordeaux.com \">INSERM U1026 BIOTIS </a>(Bordeaux), to be in partnership with clinicians to conduct translational research programs in the field of Tissue bioengineering .");
	...
	define('TXT_Menuhtml', "<li><a href=\"../index.php\">Welcome to CIC-IT</a>
	 ...
	 <li><a href=\"environnement-de-pointe.php\">advanced environment</a></li></ul></li>
	...
	<li><a href=\"systeme-qualite.php\">Quality system</a></li>
	 ...
	 <li><a href=\"fiche-de-contact.php\">Contact/Practical Information</a>
	 <ul>
	 <li><a href=\"coordonnees.php\">Contact information</a></li></ul></li>
	 <li><a href=\"admin.php\">Intranet</a>
	<ul><li><a href=\"admin.php\">Intranet</a></li></ul></li>
	 ");
...
<ul>
<li>New projects submitted to the CIC-IT are presented in monthly technical committee comprising the whole team, the representative of valuation SATT and INSERM, and the holders of new projects if necessary. </li>
    <li>To consider the proposed protocols, to evaluate the methodological and logistical feasibility, to predict performance. The selection of projects submitted to the CIC-IT is based on the relevance of the question, the adequacy of the proposed methodology, ethical, regulatory and good clinical practices, and the adequacy of the project and CIC-IT missions.</li>
<li>To monitor the implementation of approved projects. </li>
            <li> To facilitate collaboration between different actors of clinical research at the University Hospital and the continuity between pre-clinical and clinical research. </li>
            <li> Prepare the response to tenders. </li>
            <li> To make a point about the inner workings and financing of CIC-IT </li>
        </ul>
	");
	
	define('TXT_imgOrganigrammeDRCI',"DRCI Organization Chart.");
	define('TXT_legendeImgDRCI',"<b>Organizational chart<br/>DRCI</b>");
	define('TXT_SSTitreFonction',"The team");
	define('TXT_imgOrganigramme',"CIC-IT Biomaterials Organization Chart.");
	define('TXT_legendeImg',"<b>Organizational chart<br/>CIC-IT Biomaterials</b>");
	define('TXT_Equipe',"CIC-IT Leaders");
	...
	define('TXT_TMA1',"The CIC-IT is managed by an annual Strategic Orientation Committee (COS), chaired by its president <a>Prof. Jean-Christophe Fricain</a>, and bringing together the medical coordinator (<a href = \"LaurenceBordenave.php \">Pr Laurence Bordenave</a>), the delegated coordinator (<a href=\"MarleneDurand.php\">Marlène Durand $</a>), the representatives of the 
...
CIC1401
	...
	<h2 class=\"modal-title\" id=\"myModalLabel\">The CIC1401</h2>
	</div>
	<div class=\"modal-body\">
	<h4>
The CIC-IT of Bordeaux is one of the three modules of the CIC1401 of Bordeaux. The other two modules are:
- The CIC-P (Plurithematic) which provides investigative support (ARC, IDERC, investigating physicians) for clinical trials (website),
- The CIC-EC (Clinical Epidemiology), which provides methodological expertise, designs the statistical plan, implements e-FIUs and data capture, and performs statistical analysis of clinical trials.
The CIC-IT works closely with the P and EC modules of the CIC1401 for clinical trials promoted by the Bordeaux University Hospital. The three modules constitute the EUCLID F-CRIN platform.
The CIC1401 is directly dependent on the Clinical Research and Innovation Department (DRCI) of the CHU de Bordeaux and the INSERM Regional Delegation. An agreement binds the 4 guardians of the CIC401: CHU of Bordeaux, INSERM, University of Bordeaux, Institute of Fight against Cancer Bergonié.
The CIC1401 is managed by an annual steering committee and is the subject of a quadrennial evaluation by HCERES (last renewal on 1 January 2016).
</h4>
</div> </div> </div>
,<a> the Director of the PTIB </a> and the Scientific Members of CIC-IT.<a> EC and P coordinators </a> are also invited.
<br> A review of the activity is presented and the future strategic and scientific orientations
Are discussed and determined. <br> A report is drafted and sent to the participants.<br>");
...
define('TXT_TMA3',"<button class=\"btn btn-md btn-info \" data-toggle=\"modal\" data-target=\"#myModal1\" style=\"position:center;color:#9999ff; background-color:transparent; border:none; \" >
	A monthly plenary meeting (or technical committee)
	</button>
	<!-- Modal -->
	...
	<div class=\"modal-header\">
	<button type=\"button-sm\" class=\"close\" data-dismiss=\"modal\" aria-hidden=\"true\">&times;</button>
	<h2 class=\"modal-title\" id=\"myModalLabel\">The plenary meeting</h2>
	</div>
	<div class=\"modal-body\">
	It brings together the coordinators of the CIC-IT and its entire team. The representative of the SATT Aquitaine Science Transfert, the valorisation services of INSERM and the CHU de Bordeaux, and, if necessary, the project promoters, are also invited. This technical committee is led by the two coordinators and is responsible for:
<ul><li> To submit new requests for projects: discussion of their eligibility and methodological and logistical feasibility, questions to be submitted to the bearer and meetings to be organized in order to draw up the specifications and specifications. The selection of projects submitted to the CIC-IT is based on: </ li>
<li>the relevance of the question asked, </li>
<li>the adequacy of the proposed methodology, </li>
<li>respect for ethics, regulation and good clinical practice,</li>
<li>and on the adequacy of the project with the missions of the CIC-IT. </li>
<li>To discuss the answers to calls for tender during the course: subject, place of the CIC-IT (co-ordinator, partner, service provider), partnership, necessary resources, budget, deadline.</li>
<li>To monitor the execution of accepted projects in terms of administrative management, methodology, logistics, scientific results, deadlines and valorisation. Each member of the team involved provides the necessary information and actions are proposed according to the problems encountered. </li></ul>
A report is written and sent to the entire team as well as to the persons invited. At each meeting, the agenda consists of the previous report, supplemented by new projects to be discussed.
	
	</div></div></div></div> discusses the progress of ongoing projects.



<button class=\"btn btn-md btn-info \" data-toggle=\"modal\" data-target=\"#myModal2\" style=\"position:center;color:#9999ff; background-color:transparent; border:none; \" >
	...
	<div class=\"modal-header\">
	<button type=\"button-sm\" class=\"close\" data-dismiss=\"modal\" aria-hidden=\"true\">&times;</button>
	<h2 class=\"modal-title\" id=\"myModalLabel\">The meeting of functioning</h2>
	</div>
	<div class=\"modal-body\">
<ul><li>Special commands, business rules/ordering </li>
<li>Recruitments in progress,reminder of HR rules </li>
<li>Information on absences for missions/staff training</li>
<li>Teaching activities of the team (hosting trainees)</li>
<li>Relations with the CHU de Bordeaux, INSERM, University of Bordeaux</li>
<li>Functional relationships with close partners: PTIB, IHU LIRYC, U1026 INSERM, BIOTIS, other CIC1401 modules</li>
<li>Information on structuring networks: 2ACBI, FR TECSAN, ATT BxCRM, CIC-IT national network, F-CRIN TECH4HEALTH and EUCLID platforms </li>
<li>CIC-IT Quality Policy News </li>
<li>News on CIC-IT's internal and external communication </li></ul>
A report is written and sent to the entire team. At each meeting, the agenda consists of the previous minutes.	
</div></div></div></div> 

Is regularly chaired by the ICC-IT Delegate Coordinator, along with the entire team, to discuss the day-to-day organization and operation of the structure.<br>");

define('TXT_TMA4',"<div style=\"display:inline-block; margin-left:0px; \">
<h2> Secretariat/Management </h2>
...
<ul id =\"puces\"><li> setting up quality documents that frame practices and organize activities, </li>
<li> monitoring actions to address dysfunctions or actions to improve processes, </li>
<li> evaluations of our multi-level processes (process reviews, process audits and project audits) to ensure their implementation as planned. </li></ul>
	");
...
<ul id =\"puces\"><li>The CHU de Bordeaux and its Quality and Performance Department (DQP) for the guidelines and models for the preparation of quality documents, and the Directorate of Clinical Research And Innovation (DRCI), for elements specific to clinical research, </li>
<li>INSERM, because of its integration with the National Network of CICs and its participation in the group \"Harmonization of CIC procedures\" (HP-CIC). </li></ul>");
	
	define('TXT_A3Qualite',"The activities of the CIC-IT are carried out in compliance with the Norms and the legislative framework in force in France, Europe and at the international level.
...
For further information regarding the quality system, please contact the Quality Management Manager: Carolina LANCHAS FUENTES (carolina.lanchas-fuentes@chu-bordeaux.fr)
");
...
<li class = \"blink_me\" style=\"color:red; text-align:center;\"><h3> Get ISO 9001 version 2015 certification in 2018. </h3></li> ");
	...
	define('TXT_TQ',"<h1 style=\"text-align:center\"><strong>Quality management system</strong></h1>");
...
");
	...
	define('TXT_TV',"<h1 style=\"text-align:center\">Operation</h1><h2 style=\"text-align:center\">valorization</h2>");
	...
	//
	define('TXT_TM5',"Literary works (participation)");
...
<li>Preclinical <em>in vitro</em> research </li>
	...
	define('TXT_ArticleA13',"<h3 style = \" text-align:left; \">For validation </h3><div style = \" display: block; text-align:left; \">
<h6><ul>
<li> \"Implantable medical devices \" </li>
    <li> \"Natural and synthetic biomaterials \" </ li>
...
<li><em><strong>Agence de Biomédecine</em></strong>(ITOV).</li></ul></div>");
	...
	//---------------------------------------------------------
  	// page histologie
  	//---------------------------------------------------------
	define('TXT_TH',"<h1 style=\"text-align:center\">Histology platform</h1>");
...
<br/><h3>large and small cut samples</h3>");
...
<li><h4>Attachment, proliferation (EN ISO 10993-5) </h4></li>
	...
	define('TXT_CCT',"<h1 style=\"text-align:center\">cell culture platform</h1>");
...
define('TXT_CCEA1',"PSM");
	...
	define('TXT_TAB',"<h1 style=\"text-align:center\">Bacteriology</h1>");
	...
	define('TXT_HM',"<br><br><div  style=\"width:100%; text-align:left; \"><h3><strong>Hemocompatibility tests:</strong></h3><ul><li><strong>Hemolysis test according to ASTM F756-08 </strong></li><li><strong>Platelet activation test</strong></li><li><strong>Complément(C3a, CH50, SC5b-9)</strong></li><li><strong>ASTM F2888-13 counts and leukocytes of the materials used in cardiovascular.</strong</li></ul></div>");
	define('TXT_HLI1',"<strong>Hemolysis Test</strong>");
	define('TXT_HLI2',"<strong>Platelet activaion T=0min</strong>");
	define('TXT_HLI3',"<strong>Platelet activaion T=15min</strong>");
	define('TXT_HEA1',"Cells animals counter 'VetABC' <br/> CIC-IT equipment");
	define('TXT_HEA2',"Cytometer <br/> provision by PTIB");
	define('TXT_HEA3',"PSM<br>provision by PTIB?.");
...
<li>Drafting of the final report.</li></ul></div>");
	...
	define('TXT_IVEquipements',"<h2 style=\"text-align:justify;\">The facilities</h2>
	Resources from the University of Bordeaux, PTIB and IHU LIRYC :<br><br><ul><li>animal husbandry,</li><br><li>operation room,</li><br><li>X -ray imaging,</li><br><li>MRI,</li><br><li>PhotoImager,</li><br><li>ultrasound.</li></ul>");
